          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="space-y-6 text-muted-foreground font-light leading-relaxed">
                <p>
                  Sage & Oak was born from a simple observation: in our hyper-connected world, true rest has become 
                ...
                <p>
                  ...
                  Sage & Oak retreat offers a doorway back to the rhythms that sustained humanity for millennia.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="space-y-6 text-muted-foreground font-light leading-relaxed">
                ...
                <p>
                  At Sage & Oak, we believe that reconnecting with nature isn't an escape from reality—it's a 
